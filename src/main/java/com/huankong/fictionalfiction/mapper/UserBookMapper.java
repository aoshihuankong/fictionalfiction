...
public interface UserBookMapper {
    ...
    @Select("SELECT * FROM t_userbook WHERE userid = #{userid}")
    ...
    @Update("UPDATE t_userbook SET progress = #{progress}, progressLink = #{progressLink} WHERE userid = #{userid} AND bookid = #{bookid}")
